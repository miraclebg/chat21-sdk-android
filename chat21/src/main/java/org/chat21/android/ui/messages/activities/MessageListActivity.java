...
//                            Toast.LENGTH_SHORT).show();
    ...
    @Override
    public void onConversationMessageReceived(Message message, boolean ischatNotFound, ChatRuntimeException e) {
    ...
    @Override
    public void onConversationMessageDeleted(Message message, ChatRuntimeException e) {

    }

    @Override
    public void onConversationCountRecieved(long count) {
