...
// Prevent form the reflection api.
    ...
    public void signInWithUid(final Activity loginActivity, final String appId,
                              String uid, final IChatUser iChatUser, final OnChatLoginCallback onChatLoginCallback) {
        ...
        new GetCustomTokenTask(new OnCustomAuthTokenCallback() {
            ...
            public void onCustomAuthRetrievedSuccess(String token) {
                ...
                signInWithToken(loginActivity, token, iChatUser, onChatLoginCallback);
            }
...
//                    .setValue(userId);
    ...
    public void signInWithToken(final Activity loginActivity, String token, final IChatUser iChatUser,
                                final OnChatLoginCallback onChatLoginCallback) {
