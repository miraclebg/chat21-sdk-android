        ...
        ChatAuthentication.getInstance().signInAnonymously(loginActivity,
                new ChatAuthentication.OnChatLoginCallback() {
                    ...
                    public void onChatLoginSuccess(IChatUser currentUser) {
                        ...
                        start(loginActivity, appId, currentUser);
...
//        ChatAuthentication.getInstance().signInWithToken(context, configuration.fcmToken, currentUser, new ChatAuthentication.OnChatLoginCallback() {
//            @Override
//            public void onChatLoginSuccess(IChatUser currentUser) {
//
//            }
...
//        });
        ...
        if (StringUtils.isValid(configuration.firebaseUrl)) {
            root = FirebaseDatabase.getInstance().getReferenceFromUrl(configuration.firebaseUrl).child("/apps/" + configuration.appId + "/users/" + currentUser.getId() + "/instances/" + configuration.fcmToken);
        } else {
        ...
        device.put("language", configuration.language);
        device.put("app_name", configuration.appName);

        root.setValue(device);
...
//                ref.setValue(configuration.fcmToken);
//                root.removeEventListener(this);
//            }
//
//            @Override
//            public void onCancelled(@NonNull DatabaseError databaseError) {
//                Log.i("Adding Refere", "Error");
//            }
//        });
    }
