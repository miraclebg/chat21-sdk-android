...
//    }
    ...
    public void deleteConversationFromMemory(String conversationId) {
        ...
        if (index != -1) {
            deletedConversation = conversations.get(index);
            conversations.remove(index);
            sortConversationsInMemory();
            notifyConversationRemoved(deletedConversation, null);
        }

    }

    public Conversation deleteConversationFromMemory2(String conversationId) {
        int index = -1;
